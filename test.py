...
CONFIG = {
    "username": "admin",
    "password": "password",
"model_cfg": "FAINAL-PROJECT/Real_Time_Object_Detection-main (1)/Real_Time_Object_Detection-main/yolov4.cfg",
"model_weights": "FAINAL-PROJECT/Real_Time_Object_Detection-main (1)/Real_Time_Object_Detection-main/yolov4.weights",
"model_classes": "FAINAL-PROJECT/Real_Time_Object_Detection-main (1)/Real_Time_Object_Detection-main/coco.names",
...
# Initialize the capture object
cap = cv2.VideoCapture(0)  # Changed from 1 to 0
if not cap.isOpened():
